...
public class RedisConst {
    ...
    public static final String BITMAP_USERNAME = "bitmap:username";
    public static final String LOCK_USER_REGISTER = "12306:lock:user-register:";
    public static final String USER_REGISTER_REUSE_SHARDING = "12306:username-reuse:";
}
